            ...
            >
                ...
                <section >
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 mb-12 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                            {/* Basic Plan */}
                            <div className="relative z-10 bg-[#281a50] text-white rounded-2xl p-8 lg:p-10 shadow-lg transform hover:scale-105 transition-transform duration-500">

                                <div className="space-y-5">
                                    <h3 className="text-xl lg:text-2xl font-bold text-center">Basic</h3>
                                    <div className="text-center">
                                        <p className="text-4xl lg:text-5xl font-extrabold">$499</p>
                                        <p className="text-sm text-gray-400 mt-2">
                                            <span className="line-through">$649</span> Early Applicant Discount
                                        </p>
                                    </div>
                                    <p className="text-center text-blue-300 font-semibold uppercase text-sm tracking-wider">
                                        Non-Accommodation
                                    </p>
                                    <ul className="mt-4 space-y-3 text-gray-300 text-sm leading-7">
                                    ...
                                    <div className="text-center mt-8">
                                        <Link href="/RegisterNow">
                                            <button className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-semibold rounded-full shadow-md hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300">
                                                Register Now →
                                            </button>
                                        </Link>
                                    </div>
                            ...
                            <div className="relative z-10 bg-[#281a50] text-white rounded-2xl p-8 lg:p-10 shadow-lg transform hover:scale-105 transition-transform duration-500 flex flex-col justify-between h-full">
                                <div className="space-y-5">
                                    <h3 className="text-xl lg:text-2xl font-bold text-center">Accommodation</h3>
                                    <div className="text-center">
                                        <p className="text-4xl lg:text-5xl font-extrabold">$649</p>
                                    </div>
                                    <p className="text-center text-blue-300 font-semibold uppercase text-sm tracking-wider">
                                        Accommodation
                                    </p>
                            ...
                            <div className="relative z-10 bg-[#281a50] text-white rounded-2xl p-8 lg:p-10 shadow-lg transform hover:scale-105 transition-transform duration-500 flex flex-col justify-between">
                                <div className="space-y-5">
                                    <h3 className="text-xl lg:text-2xl font-bold text-center">Full Experience</h3>
                                    <div className="text-center">
                                        <p className="text-4xl lg:text-5xl font-extrabold">$799</p>
